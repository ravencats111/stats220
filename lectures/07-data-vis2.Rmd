...
### .blue[1.] Colour space
### .blue[2.] Colour blindness

---

class: middle

## 3 ways to represent colour space
...
* Hue *(0-360)*: hue of the color
* Saturation *(0-1)*: colorfulness relative to the brightness of the color
...
* Hue *(0-360)*: hue of the color
* Chroma *(0-180)*: degree of vividness of a color
...
.center[<img src = "https://clauswilke.com/dataviz/pitfalls_of_color_use_files/figure-html/red-green-cvd-sim-1.png", width = 70%></img>]
* Blue-green color-vision deficiency is rare but does occur
.center[<img src = "https://clauswilke.com/dataviz/pitfalls_of_color_use_files/figure-html/blue-green-cvd-sim-1.png", width = 70%></img>]

.footnote[image credit: Claus O. Wilke [Fundamentals of Data Visualization](https://clauswilke.com/dataviz/)]
...
.center[<iframe src="plotly.html" width="800" height="500" seamless="seamless" frameBorder="0"> </iframe>]
...
* [BBC Visual and Data Journalism cookbook for R graphics](BBC Visual and Data Journalism cookbook for R graphics)
]
