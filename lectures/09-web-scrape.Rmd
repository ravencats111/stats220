...
.pull-left[
.center[<img src = "img/browser-220.png", width = "90%"></img>]
]
.pull-right[
...
<br>
<br>
.center[<img src = "img/rvest/developer-tool.png", width = "90%"></img>]
]
.pull-right[
## <i class="fas fa-puzzle-piece"></i> [CSS selectors](https://selectorgadget.com/)
<br>
<br>
.center[<img src = "img/rvest/css-selector.png", width = "90%"></img>]
]
...
<br>
<br>
.center[<img src = "img/rvest/navbar-right.png", width = "90%"></img>]
]
.pull-right[
...
```{r html-info}
```
.center[<img src = "img/rvest/info-h3.png", width = "90%"></img>]
]
.pull-right[
...
<br>
<br>
.center[<img src = "img/rvest/info-table.png", width = "90%"></img>]
]
.pull-right[
