...
```{r root-endpoint, highlight.output = 2:5}
```
...
## Auckland Transport Open GIS Data

<https://data-atgis.opendata.arcgis.com/datasets/bus-stop?geometry=173.281%2C-37.229%2C176.247%2C-36.459>
